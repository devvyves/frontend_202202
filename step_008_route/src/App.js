    ...
    <div className="App">
      <header id="headBox">
        ...
        <nav className="gnb">
          <ul>
            <li>
              <NavLink className={({isActive})=> 'link' + (isActive ? 'on' : 'active')} to="about">about</NavLink>
            </li>
            <li>
              <NavLink className={({isActive})=> 'link ' + (isActive ? 'on' : 'active')} to="product">product</NavLink>
            </li>
            <li>
              <NavLink className={({isActive})=>isActive ? 'on' : 'active'} to="gallery">gallery</NavLink>
            </li>
            <li>
              <NavLink className={({isActive})=>isActive ? 'on' : 'active'} to="event">event</NavLink>
            </li>
          </ul>
        </nav>
      </header>
